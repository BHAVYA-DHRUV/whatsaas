          ...
          <form className="space-y-4" action={passwordAction}>
            <div>
              ...
              <PasswordInput
                ...
                toggleLabel="Show or hide current password"
              />
            </div>
            <div>
              ...
              <PasswordInput
                ...
                toggleLabel="Show or hide new password"
              />
            </div>
            <div>
              ...
              <PasswordInput
                ...
                toggleLabel="Show or hide confirm password"
              />
            </div>
            {passwordState.error && (
          ...
          <form action={deleteAction} className="space-y-4">
            <div>
              ...
              <PasswordInput
                ...
                toggleLabel="Show or hide delete account password"
              />
            </div>
            {deleteState.error && (
