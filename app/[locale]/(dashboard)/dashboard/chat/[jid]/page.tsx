...
import { X, Loader2, Users, Download, PanelRightOpen } from 'lucide-react';
...
export default function ChatPage() {
  ...
  useEffect(() => {
    if (messages && messages.length > 0 && !deferredSearchQuery) {
      const timer = setTimeout(() => scrollToBottom(), 100);
      return () => clearTimeout(timer);
    }
  }, [messages, scrollToBottom, deferredSearchQuery]);
