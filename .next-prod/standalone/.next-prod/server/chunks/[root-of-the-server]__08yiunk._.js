...
return jobId .. "" -- convert to string
`,keys:6};e.s(["addDelayedJob",0,tS],493852),e.i(493852);let tI={name:"addJobScheduler",content:`--[[
...
return {jobId .. "", delay}
`,keys:11};e.s(["addJobScheduler",0,tI],927599),e.i(927599);let tk={name:"addLog",content:`--[[
  Add job log
  Input:
    KEYS[1] job id key
    KEYS[2] job logs key
...
`,keys:2};e.s(["addLog",0,tk],592879),e.i(592879);let tE={name:"addParentJob",content:`--[[
...
return jobId .. "" -- convert to string
`,keys:6};e.s(["addParentJob",0,tE],719348),e.i(719348);let tj={name:"addPrioritizedJob",content:`--[[
...
return jobId .. "" -- convert to string
`,keys:9};e.s(["addPrioritizedJob",0,tj],855494),e.i(855494);let tw={name:"addRepeatableJob",content:`--[[
...
`,keys:2};e.s(["addRepeatableJob",0,tw],530960),e.i(530960);let tx={name:"addStandardJob",content:`--[[
...
return jobId .. "" -- convert to string
`,keys:9};e.s(["addStandardJob",0,tx],401939),e.i(401939);let tA={name:"changeDelay",content:`--[[
...
if rcall("EXISTS", ARGV[4]) == 1 then
  ...
  return -1
end`,keys:4};e.s(["changeDelay",0,tA],124195),e.i(124195);let tD={name:"changePriority",content:`--[[
  Change job priority
  Input:
    KEYS[1] 'wait',
    KEYS[2] 'paused'
...
`,keys:7};e.s(["changePriority",0,tD],321057),e.i(321057);let tT={name:"cleanJobsInSet",content:`--[[
...
return result[1]
`,keys:3};e.s(["cleanJobsInSet",0,tT],841381),e.i(841381);let tC={name:"drain",content:`--[[
...
`,keys:5};e.s(["drain",0,tC],946888),e.i(946888);let tO={name:"extendLock",content:`--[[
...
return 0
`,keys:2};e.s(["extendLock",0,tO],556111),e.i(556111);let tM={name:"extendLocks",content:`--[[
...
return failedJobs
`,keys:1};e.s(["extendLocks",0,tM],146003),e.i(146003);let tR={name:"getCounts",content:`--[[
...
return results
`,keys:1};e.s(["getCounts",0,tR],319884),e.i(319884);let tP={name:"getCountsPerPriority",content:`--[[
  Get counts per provided states
    Input:
      KEYS[1] wait key
      KEYS[2] paused key
...
return results
`,keys:4};e.s(["getCountsPerPriority",0,tP],365535),e.i(365535);let tJ={name:"getDependencyCounts",content:`--[[
...
return results
`,keys:4};e.s(["getDependencyCounts",0,tJ],164623),e.i(164623);let tN={name:"getJobScheduler",content:`--[[
...
return {nil, nil}
`,keys:1};e.s(["getJobScheduler",0,tN],833429),e.i(833429);let tL={name:"getMetrics",content:`--[[
  Get metrics
  Input:
    KEYS[1] 'metrics' key
...
`,keys:2};e.s(["getMetrics",0,tL],636069),e.i(636069);let tq={name:"getRanges",content:`--[[
...
return results
`,keys:1};e.s(["getRanges",0,tq],640615),e.i(640615);let tF={name:"getRateLimitTtl",content:`--[[
  Get rate limit ttl
    Input:
      KEYS[1] 'limiter'
      KEYS[2] 'meta'
...
`,keys:2};e.s(["getRateLimitTtl",0,tF],995884),e.i(995884);let tV={name:"getState",content:`--[[
  Get a job state
  Input: 
...
return "unknown"
`,keys:8};e.s(["getStateV2",0,tG],306789),e.i(306789);let t_={name:"isFinished",content:`--[[
...
return 0
`,keys:3};e.s(["isFinished",0,t_],271707),e.i(271707);let tY={name:"isJobInList",content:`--[[
...
`,keys:1};e.s(["isJobInList",0,tY],568134),e.i(568134);let tB={name:"isMaxed",content:`--[[
...
`,keys:2};e.s(["isMaxed",0,tB],979499),e.i(979499);let tz={name:"moveJobFromActiveToWait",content:`--[[
...
`,keys:9};e.s(["moveJobFromActiveToWait",0,tz],991017),e.i(991017);let tW={name:"moveJobsToWait",content:`--[[
...
return 0
`,keys:8};e.s(["moveJobsToWait",0,tW],173652),e.i(173652);let tU={name:"moveStalledJobsToWait",content:`--[[
...
return stalled
`,keys:8};e.s(["moveStalledJobsToWait",0,tU],326867),e.i(326867);let tH={name:"moveToActive",content:`--[[
...
return {0, 0, 0, 0}
`,keys:11};e.s(["moveToActive",0,tH],210393),e.i(210393);let tQ={name:"moveToDelayed",content:`--[[
...
`,keys:12};e.s(["moveToDelayed",0,tQ],678399),e.i(678399);let tZ={name:"moveToFinished",content:`--[[
...
`,keys:14};e.s(["moveToFinished",0,tZ],328646),e.i(328646);let tX={name:"moveToWaitingChildren",content:`--[[
...
return -1
`,keys:7};e.s(["moveToWaitingChildren",0,tX],982792),e.i(982792);let t$={name:"obliterate",content:`--[[
...
`,keys:2};e.s(["obliterate",0,t$],935933),e.i(935933);let t0={name:"paginate",content:`--[[
...
`,keys:7};e.s(["pause",0,t1],877380),e.i(877380);let t2={name:"promote",content:`--[[
...
`,keys:9};e.s(["promote",0,t2],330498),e.i(330498);let t3={name:"releaseLock",content:`--[[
  Release lock
    Input:
      KEYS[1] 'lock',
      ARGV[1]  token
...
`,keys:1};e.s(["releaseLock",0,t3],347776),e.i(347776);let t4={name:"removeChildDependency",content:`--[[
...
if removeParentDependencyKey(jobKey, false, parentKey, KEYS[1], nil) then
  ...
  return 1
end`,keys:1};e.s(["removeChildDependency",0,t4],890342),e.i(890342);let t6={name:"removeDeduplicationKey",content:`--[[
...
return 0
`,keys:1};e.s(["removeDeduplicationKey",0,t6],691933),e.i(691933);let t5={name:"removeJob",content:`--[[
...
return 0
`,keys:2};e.s(["removeJob",0,t5],225665),e.i(225665);let t9={name:"removeJobScheduler",content:`--[[
...
return 1
`,keys:3};e.s(["removeJobScheduler",0,t9],973024),e.i(973024);let t8={name:"removeOrphanedJobs",content:`--[[
...
return 1
`,keys:3};e.s(["removeRepeatable",0,t7],766357),e.i(766357);let re={name:"removeUnprocessedChildren",content:`--[[
    Remove a job from all the statuses it may be in as well as all its data.
    In order to be able to remove a job, it cannot be active.
    Input:
      KEYS[1] jobKey
...
removeJobChildren(prefix, jobKey, options) 
`,keys:2};e.s(["removeUnprocessedChildren",0,re],772997),e.i(772997);let rt={name:"reprocessJob",content:`--[[
...
`,keys:8};e.s(["reprocessJob",0,rt],887721),e.i(887721);let rr={name:"retryJob",content:`--[[
...
`,keys:11};e.s(["retryJob",0,rr],832559),e.i(832559);let rn={name:"saveStacktrace",content:`--[[
...
`,keys:1};e.s(["saveStacktrace",0,rn],120332),e.i(120332);let ra={name:"updateData",content:`--[[
  Update job data
  Input:
    KEYS[1] Job id key
    ARGV[1] data
...
`,keys:1};e.s(["updateData",0,ra],647479),e.i(647479);let ri={name:"updateJobScheduler",content:`--[[
...
`,keys:12};e.s(["updateJobScheduler",0,ri],774677),e.i(774677);let rs={name:"updateProgress",content:`--[[
  Update job progress
  Input:
    KEYS[1] Job id key
...
`,keys:3};e.s(["updateProgress",0,rs],470855),e.i(470855);let ro={name:"updateRepeatableJobMillis",content:`--[[
  Adds a repeatable job
    Input:
      KEYS[1] 'repeat' key
      ARGV[1] next milliseconds
